...
<p><?php echo $this->Html->link('This link', $resetLink, array('style' => 'color:#0AAAAD;')); ?> will reset your email. If the link cannot be clicked copy the following URL into your browser's address bar.</p>
